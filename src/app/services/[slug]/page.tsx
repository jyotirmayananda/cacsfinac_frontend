  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <ServiceDetailHero
        ...
        slug={service.slug}
        primaryCtaText={details.heroButton}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {details.introductionParagraphs.map((p, i) => (
                  <p
                    key={i}
      ...
      <section className="py-24 md:py-40 dark:bg-slate-900 bg-slate-100/30 text-foreground overflow-hidden relative border-y border-border/50">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-24 space-y-6">
            {details.howWeWorkHeading ? (
              <>
                <h2 className="text-3xl md:text-5xl font-bold font-headline">
                  {details.howWeWorkHeading}
                </h2>
                <h3 className="text-2xl md:text-4xl font-bold font-headline text-foreground">
                  {details.processHeading}
                </h3>
              </>
            ) : (
              <h2 className="text-3xl md:text-5xl font-bold font-headline">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {details.whyChooseUs.map((item, index) => (
                <div
                  key={index}
                  className="p-8 rounded-3xl bg-muted/50 border border-border/50 hover:border-primary/50 hover:bg-muted transition-all duration-500"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="relative rounded-[4rem] overflow-hidden dark:bg-slate-900 bg-slate-50 text-foreground p-12 md:p-24 text-center border border-border/50 shadow-2xl">
            ...
            <div className="relative z-10 max-w-4xl mx-auto space-y-10">
              <h2 className="text-4xl md:text-6xl font-bold font-headline leading-[1.1] tracking-tight text-foreground">
                {details.ctaTitle}
              </h2>
              ...
              <div className="flex flex-col items-center gap-10">
                <Button
                  size="lg"
                  className="rounded-full px-16 h-20 text-xl font-bold shadow-2xl shadow-primary/20 hover:scale-105 transition-transform group"
                  asChild
                >
                  <Link href="/contact">
                    {details.ctaButton}
                ...
                <p className="text-xs font-bold tracking-widest text-muted-foreground/80">
                  {details.ctaSmallText}
                </p>
              </div>
            </div>
          </div>
