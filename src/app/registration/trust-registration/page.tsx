            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  to promote the development of sciences, literature, and other
                  worthy causes. They serve purposes such as alleviating
                  scarcity, providing education to those in need, and offering
                  medical support. Trust registration is officially registering
                  a trust under the Trusts Act of 1882. This legal step ensures
                  that the trust is recognized and operates within the framework
                  of the law. Trust registration online provides legal validity
                  and establishes its existence as a separate entity.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4 pl-5 list-disc text-muted-foreground">
                  {partiesInvolved.map((party, index) => (
                    <li key={index}>
                      <strong>{party.title}:</strong> {party.description}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  activities they undertake. You need to understand these types
                  to navigate how to register a trust in India. Here are the
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-justify">
                    Private Limited Trusts are established to carry out
                    activities for specific individuals, families, or close
                    associates. These trusts can have beneficiaries closely
                    related to the trust's founders. Private limited trusts are
                  ...
                  <p className="text-muted-foreground text-justify">
                    ...
                    educational, and religious purposes and are governed by
                    specific statutes such as the Religious Endowments Act of
                    1863, the Charitable and Religious Trust Act of 1920, or the
                    Bombay Public Trust Act of 1950. Charitable and religious
                    trusts are the most common types of public trusts in India.
                  </p>
                  <h3 className="font-semibold">Public Cum-Private Trust:</h3>
                  <p className="text-muted-foreground text-justify">
                    This type of trust serves both public and private purposes.
                    It can utilize its income for the benefit of the public and
                    specific individuals or families. The beneficiaries of a
                    public cum-private trust can be a combination of public and
                    private individuals.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  A trust deed is a crucial document that outlines the key
                  details and provisions of a trust. It encompasses the
                  following clauses:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {trustDeedContents.map((content, index) => (
                    <li key={index}>{content}</li>
                  ))}
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  The trust deed serves as a legally binding document that
                  governs the operations and functioning of the trust, providing
                  clarity and guidance to all parties involved.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Ensure to have these documents before engaging on the
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {registrationProcedure.map((step, index) => (
