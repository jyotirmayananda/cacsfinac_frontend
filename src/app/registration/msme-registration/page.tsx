...
const registrationSteps = [
  {
    ...
    description:
      "Begin by accessing the official Udyam Registration Portal at https://udyamregistration.gov.in.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Provide your Aadhaar number and name, then validate using the OTP sent to your registered mobile number. Subsequently, enter your PAN details and validate them.",
  },
  {
    title: "Fill in Business Information",
    description:
      "Input essential details such as business name, address, bank account information, and the National Industry Classification (NIC) code relevant to your business activities.",
  },
  {
    title: "Specify Investment and Turnover Details",
    description:
      "Enter the investment in plant and machinery or equipment and the annual turnover figures. Ensure these figures align with the revised MSME classification criteria effective from April 1, 2025.",
  },
  {
    title: "Submit the Application",
    description:
      "After reviewing all the information, submit the application. Upon successful submission, you will receive an e-certificate known as the Udyam Registration Certificate, which includes a unique Udyam Registration Number (URN).",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  of India's economy, contributing significantly to employment
                  and GDP. Recognizing their importance, the Government of India
                  has streamlined the MSME registration process and revised
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> The registration process is paperless
                  and based on self-declaration; no physical documents are
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Revised MSME Classification Criteria (Effective April 1, 2025)
                </h2>
                <Table>
                  <TableHeader>
                    <TableRow>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose CACSFinacc for Your MSME Registration?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
