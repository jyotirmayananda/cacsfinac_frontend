...
const registrationSteps = [
  {
    ...
    description:
      "All proposed directors and subscribers must acquire a Class 3 DSC to sign electronic documents on the MCA portal. This can be obtained from government-recognized certifying authorities and typically takes 1–2 business days.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Propose up to two unique names for your company using Part A of the SPICe+ form. Ensure the names comply with the Companies (Incorporation) Rules, 2014. Upon approval, the name is reserved for 20 days.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Prepare the electronic Memorandum of Association (e-MoA) and Articles of Association (e-AoA), which define the company's constitution and internal rules. These documents must be digitally signed by all subscribers.",
  },
  {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  Establishing a Private Limited Company (Pvt Ltd) in India
                  offers entrepreneurs a structured business model with benefits
                  like limited liability, separate legal identity, and ease of
                  fundraising. The Ministry of Corporate Affairs (MCA) has
                  streamlined the incorporation process, making it more
                  efficient and entirely online.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  At CACSFinacc, we offer a cost-effective service to register
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  two members and two directors for its operation. Here are the
                  key characteristics of a private limited company in India,
                  which justify the PVT LTD company registration:
                </p>
