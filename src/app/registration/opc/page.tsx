...
const registrationSteps = [
  {
    ...
    description:
      "The sole promoter must acquire a Class 3 DSC to sign electronic documents on the Ministry of Corporate Affairs (MCA) portal. This can be obtained from government-recognized certifying authorities and typically takes 1–2 business days.",
  },
  {
    title: "Apply for Director Identification Number (DIN)",
    description:
      "DIN is a unique identification number for directors. For new companies, DIN can be applied for within the SPICe+ form during the incorporation process.",
  },
  {
    title: "Reserve Company Name via SPICe+ Part A",
    description:
      "Propose a unique name for your OPC using Part A of the SPICe+ form. Ensure the name complies with the Companies (Incorporation) Rules, 2014. Upon approval, the name is reserved for 20 days.",
  },
  {
    title: "File SPICe+ Part B for Incorporation",
    description:
      "Complete Part B of the SPICe+ form, which integrates various services:",
    items: [
  ...
  },
  {
    ...
    description:
      "Prepare the electronic Memorandum of Association (e-MoA) and Articles of Association (e-AoA), which define the company's constitution and internal rules. These documents must be digitally signed by the sole promoter.",
  },
  {
    title: "Submit Form INC-3 for Nominee Consent",
    description:
      "Appoint a nominee who will take over the OPC in case of the promoter's death or incapacity. The nominee must provide consent using Form INC-3, which should be filed along with the incorporation documents.",
  },
  {
    title: "Obtain Certificate of Incorporation (COI)",
    description:
      "Upon successful verification, the Registrar of Companies (ROC) issues the COI, which includes the company's Corporate Identification Number (CIN), PAN, and TAN. These documents are sent via email to the registered address.",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  A One Person Company (OPC) is a unique business structure in
                  India that allows a single individual to operate a corporate
                  entity with limited liability and fewer compliance
                  requirements. Introduced under the Companies Act, 2013, OPCs
                  are ideal for solo entrepreneurs, consultants, and small
                  business owners seeking the benefits of a private limited
                  company without the complexities of multiple shareholders.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  At CACSFinacc, we specialize in simplifying the OPC
                  ...
                  dedicated to assisting you at every step to register one
                  person company, from document preparation to filing, we offer
                  expert guidance to help you make informed decisions regarding
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  eligibility criteria and limitations that govern its
                  formation. The Companies Act sets out clear requirements that
                  must be met to ensure that the individual promoting the
                  1-person company is eligible to do so.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold">
                      For the Sole Promoter and Nominee:
                    </h3>
              ...
              <div>
                ...
                <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Government Fees:</strong> No minimum capital
                    requirement; fees vary based on authorized capital and
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Recent Amendments Impacting OPCs (Effective April 1, 2021)
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose Our CACSFinacc Services?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
