...
const licenseTypes = [
  ...
  },
  {
    title: "Type B:",
    description:
      "Issued to units in manufacturing and processing that utilize machinery and electricity, such as milling units.",
  },
  {
    title: "Type C:",
    description:
      "Provided for high-risk activities, including producing fireworks and wood and timber structures.",
  },
];
...
const registrationSteps = [
  {
    ...
    description:
      "Identify the appropriate license category based on your business activity and location.",
  },
  {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  Obtaining a Trade License is a legal requirement for
                  businesses operating in India. It ensures that your business
                  complies with local municipal laws and regulations. This guide
                  provides an updated overview of the Trade License registration
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  Trade licenses are typically issued by the licensing
                  department of the Municipal Corporation, which encompasses
                  various departments such as industries, engineering, and
                  health. These departments grant permission through a formal
                  document or trade license certificate, allowing businesses to
                  operate within their jurisdiction. The issuance process may
                  vary from state to state, depending on the rules and
                  regulations of local government agencies, specifically the
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Steps for Trade License Registration
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Recent Amendments in Trade License Regulations (2025)
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Fees:</strong> The Trade License fee varies
                    depending on the nature and size of the business and the
                    local municipal corporation's regulations.
                  </li>
                  <li>
                    <strong>Timeline:</strong> The processing time for a Trade
                    License application typically ranges from 7 to 15 days,
                    depending on the efficiency of the municipal corporation.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose CACSFinacc for Your Trade License Registration?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
