...
const registrationSteps = [
  {
    ...
    description:
      "Select a unique and meaningful name for your business that isn't already trademarked or registered. This helps in establishing a distinct brand identity.",
  },
  {
    title: "Obtain a PAN Card",
    description:
      "A Permanent Account Number (PAN) is essential for taxation and financial transactions. If you don't have one, apply through the Income Tax Department.",
  },
  {
    title: "Link PAN with Aadhaar",
    description:
      "Ensure your PAN is linked with your Aadhaar for seamless verification and compliance with government regulations.",
  },
  {
    title: "Register under Udyam (MSME)",
    description:
      "Registering under the Ministry of Micro, Small & Medium Enterprises (MSME) through the Udyam portal provides official recognition and access to various benefits like easier loan approvals and tax advantages.",
  },
  {
    title: "Obtain GST Registration (If Applicable)",
    description:
      "If your annual turnover exceeds ₹20 lakh (₹10 lakh for special category states), GST registration becomes mandatory. It enables tax collection, input credit claims, and is essential for interstate and B2B transactions.",
  },
  {
    title: "Acquire Shop & Establishment License",
    description:
      "Depending on your state regulations, obtain a Shop & Establishment license from the local authority. This is mandatory in many states and is essential for opening a business bank account.",
  },
  {
    title: "Open a Business Bank Account",
    description:
      "With the above documents, open a current account in your business name to manage financial transactions professionally.",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  business structure in India, ideal for individual
                  entrepreneurs starting small businesses. While it doesn't
                  require mandatory central registration, obtaining specific
                  operational registrations is essential for legal recognition
                  and smooth operations. One pivotal tax registration is the GST
                  (Goods and Services Tax) Registration, which must be secured
                  under the proprietor's name to formalize the business's
                  proprietorship status. CACSFinacc helps you to register
                  proprietorship firm online easily and effortlessly.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Government Fees:</strong> Minimal; varies based on
                    the registrations required.
                  </li>
                  <li>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Recent Amendments Impacting Sole Proprietorships (Effective
                  2025)
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose CACSFinacc for Your Sole Proprietorship
                  Registration?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
