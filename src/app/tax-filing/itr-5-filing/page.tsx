...
const keyAmendments = [
  ...
  },
  {
    ...
    items: [
      "ITR-5 now includes mandatory reporting of virtual digital assets.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      "Whether books of account have an audit trail functionality (as per MCA rules).",
    ],
  },
  {
...
const auditApplicability = [
  ...
  {
    title:
      "ICAI mandates proper record keeping, ethical reporting, and compliance with SA standards (Standards on Auditing).",
    items: [],
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  notified the updated Income Tax Return (ITR) Form 5 for the
                  Assessment Year (AY) 2025–26, effective from April 1, 2025.
                  This revised form introduces several significant amendments
                  aimed at enhancing compliance, transparency, and alignment
                  with recent tax reforms.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  CACSFinacc is your trusted partner for hassle-free and
                  efficient Income Tax Return (ITR) filing services in India.
                  Our ITR-5 service is designed to cater to the specific needs
                  of firms, the Association of Persons (AOP), and the Body of
                  Individuals (BOI) looking to file their income tax returns
                  seamlessly. With our user-friendly platform, expert
                  assistance, and competitive pricing, ITR 5 income tax filing
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ITR-5 is the prescribed Income Tax Return form for a wide
                  range of non-individual entities such as:
                </p>
                ...
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> Not applicable for individuals, HUFs
                  (use ITR-1 to ITR-4), or companies (use ITR-6). Individuals,
                  Hindu Undivided Families (HUFs), companies, and entities
                  required to file ITR-7 (such as charitable or religious
                  trusts) are not eligible to use ITR-5.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Who Should File ITR-5 in AY 2025-26?
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Key Amendments & Updates in ITR-5 for AY 2025-26
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                  As per recent updates by CBDT for AY 2025-26:
                </p>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Compliance & Audit Applicability
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why CACSFinacc is Your Trusted Partner for ITR-5 Filing
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
