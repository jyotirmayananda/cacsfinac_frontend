...
const cbRequiredConditions = [
  ...
  {
    condition: "Exempted category under Rule 37BB (e.g. travel, student fees)",
    required: "No",
  },
  {
    condition: "Remittance covered under DTAA",
    required: "Yes (to validate treaty benefit)",
  },
...
const formRequirements = [
  ...
  {
    type: "Non-Taxable as per DTAA",
    form15ca: "Required",
    form15cb: "Required",
  },
  {
    type: "Remittances below ₹5 Lakh (FY)",
    form15ca: "Required (Part A only)",
    form15cb: "Not Required",
  },
  {
    type: "Specified Transactions (Rule 37BB)",
    form15ca: "Not Required",
    form15cb: "Not Required",
  },
];
...
const ourProcess = [
  {
    ...
    description:
      "Assess nature of remittance and determine if 15CB is required",
  },
  {
    title: "Document Collection & TDS Computation",
    description:
      "Review invoice, agreement, PAN of non-resident, DTAA applicability, and TDS rate",
  },
  {
    title: "Preparation & Filing of Form 15CB",
    description: "Issued by ICAI-registered CA with UDIN and digital signature",
  },
  {
    title: "Generate & Submit Form 15CA (Part B/C/D)",
    description: "Based on 15CB or self-declaration, submitted online",
  },
  {
    title: "Delivery of Final Signed Forms",
    description:
      "Shared with client and bank for processing the outward remittance",
  },
];

const penalties = [
  {
    nonCompliance: "Failure to File Form 15CA/15CB",
    penalty: "₹1,00,000 under Section 271-I",
  },
  {
    nonCompliance: "Incorrect Information",
    penalty: "₹10,000 under Section 271B",
  },
  {
    nonCompliance: "Delayed Filing",
    penalty: "Additional interest under Section 234E",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  Forms 15CA and 15CB are critical for remittances outside
                  India, ensuring that tax compliance is met under Section 195
                  of the Income Tax Act, 1961 before transferring funds to a
                  non-resident or foreign entity.
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Form 15CA:</strong> Self-declaration by the remitter
                    confirming TDS deduction on foreign remittance, submitted on
                    the Income Tax e-filing portal.
                  </li>
                  <li>
                    <strong>Form 15CB:</strong> Certificate from a Chartered
                    Accountant verifying the nature, taxability, and TDS
                    deduction on foreign remittance—required in specific cases.
                  </li>
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  These forms are integral to RBI’s Liberalised Remittance
                  Scheme (LRS) and are mandatorily required by banks before
                  processing any foreign payment.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why are Form 15CA and 15CB Important?
                </h2>
                <p className="text-muted-foreground mb-2">
                  The forms are crucial for the following reasons:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-2">
                  You need to file 15CA and/or 15CB if you’re sending money
                  abroad for:
                </p>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  CACSFinacc 15CA/15CB Filing Process
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {penalties.map((item, index) => (
                    <li key={index}>
                      <strong>{item.nonCompliance}:</strong> {item.penalty}
                    </li>
                  ))}
                </ul>
              </div>
