            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-6">
                  ...
                  employees are required to register for PF and contribute
                  towards the retirement savings of their workforce.
                </p>
                <h3 className="text-xl font-bold font-headline mb-4">
                  Our PF Services Include:
                </h3>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-6">
                  ...
                  salaried employees, professionals, and business owners. The
                  tax rates and regulations vary across different states in
                  India.
                </p>
                <h3 className="text-xl font-bold font-headline mb-4">
