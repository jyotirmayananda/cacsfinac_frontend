...
const gstReturns = [
  ...
  },
  {
    name: "GSTR-5A",
    description:
      "For providers of online information and database access or retrieval services.",
  },
  {
    name: "GSTR-6",
    description:
  ...
  {
    name: "GSTR-7",
    description: "For entities required to deduct TDS under GST.",
  },
  {
    name: "GSTR-8",
    description:
...
const dueDates = [
  {
    return: "GSTR-1",
    taxpayer: "Regular Taxpayer",
    dueDate:
      "Monthly: 11th of the following month\nQuarterly: 13th of the month following the quarter",
  },
  {
    return: "GSTR-2A (Auto-generated)",
    taxpayer: "All Taxpayers",
    dueDate: "Auto-generated, utilized for reconciliation purposes",
  },
  {
    return: "GSTR-3B",
    taxpayer: "Regular Taxpayer",
    dueDate: "Monthly: 20th of the following month",
  },
  {
    return: "GSTR-4",
    taxpayer: "Composition Scheme Dealer",
    dueDate: "Annually: 30th of April following the end of the financial year",
  },
  {
    return: "GSTR-5",
    taxpayer: "Non-Resident Foreign Taxpayer",
    dueDate: "20th of the following month",
  },
  {
    return: "GSTR-6",
    taxpayer: "Input Service Distributor",
    dueDate: "13th of the following month",
  },
  {
    return: "GSTR-7",
    taxpayer: "Tax Deducted at Source (TDS)",
    dueDate: "10th of the following month",
  },
  {
    return: "GSTR-8",
    taxpayer: "E-commerce Operator",
    dueDate: "10th of the following month",
  },
  {
    return: "GSTR-9",
    taxpayer: "Regular Taxpayer (Annual)",
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground mt-4">
                  <li>
                    <strong>Purchases:</strong> It records in detail the
                    purchases the taxpayer has made.
                  </li>
                  <li>
                    <strong>Sales:</strong> It provides a comprehensive log of
                    the taxpayer's sales activities.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Input Tax Credit (GST Paid on Purchases):</strong>{" "}
                    It lists the GST paid on purchases, which is eligible to be
                    deducted from the GST owed on sales.
                  </li>
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  At CACSFinacc Services, we offer expert GST return filing
                  services, ensuring your business remains compliant with the
                  latest regulations.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  entities whose annual aggregate turnover surpasses the
                  specified threshold, which is set by the tax authorities and
                  may differ for various classifications of taxpayers, such as
                  standard taxpayers and those opting for the composition
                  scheme. All those applicable entities must file GST returns
                  before the due date to avoid late GST filing charges.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  Within the Goods and Services Tax (GST) system, 13 returns
                  cater to different facets of a taxpayer's financial dealings.
                  It's important to recognize that not all taxpayers must file
                  every type of return; the specific returns that need to be
                  filed depend on the taxpayer's category and the particulars of
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Additionally, there are return-related statements for input
                  tax credits:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground mt-4">
                  <li>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  ...
                  permits the declaration of B2B sales during the first two
                  months of a quarter. Nonetheless, these taxpayers are
                  obligated to remit taxes monthly using Form PMT-06.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  additional GST filing charges. Businesses should submit on
                  time to avoid these costs. Here's what you need to know about
                  late GST returns:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Key GST Updates Effective April 1, 2025
                </h2>
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Expertise:</strong> Our team stays updated with the
                    latest GST regulations to provide accurate and timely
                    services.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    business adheres to all GST compliance requirements,
