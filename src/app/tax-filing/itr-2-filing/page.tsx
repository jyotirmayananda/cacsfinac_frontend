...
const keyUpdates = [
  {
    ...
    description:
      "The ITR-2 form now features a separate section for detailed reporting of capital gains, including provisions for claiming capital losses from share buybacks effective from October 1, 2024. It requires mandatory reporting of sale proceeds from listed and unlisted shares separately.",
  },
  {
    title: "Increased Asset Reporting Threshold",
    description:
      "Taxpayers with gross total income exceeding ₹1 crore are now required to furnish details of assets and liabilities, raising the threshold from the previous ₹50 lakh limit.",
  },
  {
    title: "Mandatory Disclosure of TDS Sections",
    description:
      "Taxpayers must specify the relevant Tax Deducted at Source (TDS) section under which tax was deducted for each income source, enhancing transparency and accuracy in tax reporting.",
  },
  {
    title: "Aadhaar Enrolment ID No Longer Accepted",
    description:
      "The ITR-2 form has removed the column for Aadhaar Enrolment ID. Taxpayers must now provide their actual Aadhaar number when filing returns.",
  },
  {
    title: "Disclosure of Virtual Digital Assets (VDAs)",
    description:
      "Mandatory disclosure of all VDA transactions, including cryptocurrencies and NFTs. A tax rate of 30% applies on gains, with TDS at 1% on transactions above ₹50,000 for specified individuals.",
  },
  {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  taxpayers report their income and applicable taxes to the
                  income tax department. The Income Tax Act of 1961 outlines all
                  the ITR forms and procedures. Among these forms, the ITR-2
                  form is designated for individuals and Hindu Undivided
                  Families who do not generate income from professional or
                  business activities. Understanding what ITR-2 is crucial for
                  individuals having income from sources such as salary, house
                  property, capital gains, or other sources apart from business
                  or profession.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  At CACSFinacc Services, we provide expert services for
                  seamless and error-free ITR-2 Return Filing for individuals
                  and HUFs. We understand the complexities involved in declaring
                  income from multiple sources, including capital gains, foreign
                  assets, and more. Our team ensures complete compliance with
                  the Income Tax Act, 1961, and the latest guidelines issued by
                  the Income Tax Department for the Assessment Year 2025-26.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ITR-2 is the Income Tax Return form applicable for individuals
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  <strong>Note:</strong> ITR-2 is not applicable for individuals
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    Individuals or Hindu Undivided Families (HUFs) with Income
                    stemming from business or professional activities.
                  </li>
                  <li>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Key Updates for Assessment Year (AY) 2025–26
                </h2>
