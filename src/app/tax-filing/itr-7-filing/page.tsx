...
const keyAmendments = [
  {
    ...
    description:
      "The revised ITR-7 mandates increased disclosure by political parties, charitable trusts, universities, and research institutions regarding:",
    items: [
    ...
    extra:
      "These changes aim to enhance transparency and accountability in financial reporting by organizations eligible to file ITR-7. The newly required disclosures seek to strengthen oversight on the inflow and use of foreign donations and contributions within these institutions.",
  },
  {
    title: "Revised Reporting Requirements for Anonymous Donations",
    description:
      "A new column has been introduced in Schedule VC to report anonymous donations not taxable under Section 115BBC. This exemption applies when the total of such donations exceeds ₹1 lakh or 5% of total donations.",
  },
  {
    title: "Updated Schedule A – Application of Income",
    description:
      "Schedule A now requires the disclosure of donations made to other registered or approved trusts or institutions, including the percentage considered as application of income. The Finance Act, 2023, has reduced this percentage to 85%.",
  },
  {
    title: "Form 10 Filing Details",
    description:
      "When accumulating income under Sections 11(2) and 11(5) or the third proviso to Section 10(23C), the ITR-7 now requires reporting whether Form 10 was filed with the Assessing Officer and the filing date, if applicable.",
  },
  {
    title: "Introduction of Residuary Clause in Part B-TI",
    description:
      "A new column has been added to report any other income not exempt under the Income Tax Act. This addition aims to capture all sources of income for comprehensive reporting.",
  },
];

const latestUpdates = [
  {
    title: "Revised Audit Reporting Format (Form 10B & 10BB)",
    description:
      "Trusts and institutions must ensure audit compliance as per amended rules.",
  },
  {
    title: "Mandatory UDIN Integration",
    description: "CA’s UDIN must be validated for all audit reports attached.",
  },
  {
    title: "Updated Schedule ER & EC",
    description:
      "Detailed segregation of expenditure related to corpus, other funds, and applied income.",
  },
  {
    title: "Foreign Contributions (FCRA) Declaration",
    description:
      "Entities receiving foreign donations must disclose in prescribed format.",
  },
  {
    title: "Schedule TDS Reconciliation",
    description: "Enhanced TDS credit validation with Form 26AS and AIS.",
  },
  {
    title: "PAN-Aadhaar Validation",
    description:
      "Institutions must ensure linking of Aadhaar for key personnel or signatories.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-8">
              <h1 className="text-3xl md:text-4xl font-bold font-headline mb-4">
                ITR-7 Filing: Comprehensive Tax Solutions for Trusts and Exempt
                Entities
              </h1>

              <div>
                <p className="text-muted-foreground text-justify">
                  The Income Tax Department has released the updated Income Tax
                  Return (ITR) Form 7 for the Assessment Year (AY) 2025–26,
                  effective from April 1, 2025. This revised form introduces
                  several significant amendments aimed at enhancing compliance,
                  transparency, and alignment with recent tax reforms.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  including trusts, societies, and institutions that are
                  claiming exemption under the following sections of the Income
                  Tax Act, 1961:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Section 139(4A):</strong> Charitable or religious
                    trusts
                  </li>
                  <li>
                    <strong>Section 139(4B):</strong> Political parties
                  </li>
                  <li>
                    <strong>Section 139(4C):</strong> Scientific research
                    institutions, hospitals, universities, etc.
                  </li>
                  <li>
                    <strong>Section 139(4D):</strong> Colleges or educational
                    institutions not required to furnish return under any other
                    provision
                  </li>
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  If your entity claims income exemption under Section 11, 12,
                  10(23C), or 10(46), ITR-7 is mandatory.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  These entities are required to file ITR-7 to report their
                  income, claim exemptions, and ensure compliance with the
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Who Should File ITR-7 in AY 2025-26?
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                  Entities falling under the following categories must file
                  ITR-7:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Compliance for Charitable and Exempt Entities
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Key Amendments in ITR-7 for AY 2025–26
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Latest CBDT Amendments and Income Tax Utility Changes
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                  As per the latest CBDT amendments and Income Tax utility
                  changes:
                </p>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Key Disclosures Required in ITR-7
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Step-by-Step ITR-7 Filing Process at CACSFinacc
                </h2>
                <ol className="space-y-3 list-decimal pl-5 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  At CACSFinacc, we specialize in providing comprehensive tax
                  services, including:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
