...
const keyAmendments = [
  ...
  },
  {
    ...
    items: [
      "Income from Virtual Digital Assets (VDAs) must be separately disclosed under Schedule VDA. with a 30% tax rate applied.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      "Adjustments in advance tax liability calculations for businesses with fluctuating cash flows.",
    ],
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  ITR-3 is specifically designed for individuals and Hindu
                  Undivided Families (HUFs) who have income from profits and
                  gains of business or profession. This includes both
                  proprietary businesses and professional income. For AY
                  2025-26, significant amendments and procedural changes have
                  been introduced, aligning with the latest Finance Act, 2023.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  CACSFinacc Services offers specialized ITR-3 Return Filing
                  solutions tailored for individuals and Hindu Undivided
                  Families (HUFs) engaged in business or professional
                  activities. With the latest amendments for Assessment Year
                  (AY) 2025-26, our expert team ensures accurate, compliant, and
                  timely filings.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> Those eligible for ITR-1, ITR-2, or
                  ITR-4 should not use ITR-3.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  An individual or Hindu Undivided Family (HUF) earning income
                  as a partner of a partnership firm engaged in a business or
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  The due date for filing the ITR Form 3, which is the income
                  tax return, varies depending on whether the case is an audit
                  case or a non-audit case for different assessment years:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  These dates are subject to change by the income tax
                  authorities, so it's essential to stay updated with any
                  revisions or extensions of the due dates.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  ...
                  on the taxpayer's total income and other factors.
                  Additionally, if your total income is less than ₹ 5 lakh, the
                  maximum late filing fee is capped at ₹ 1,000. Therefore, it's
                  advisable to file your ITR form 3 on time to avoid these
                  penalties and any potential legal consequences.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  To file your income tax return (ITR) on CACSFinacc for ITR-3,
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Having these documents ready will make the ITR filing process
