...
const whoNeedsToEFile = [
  ...
  {
    title: "Business Owners (including SMEs & MSMEs)",
    description:
  ...
  },
  {
    ...
    description:
      "If you receive income from dividends, interest, or capital gains, it’s mandatory to report and pay applicable taxes through ITR.",
    items: [
      "Dividends (mutual funds, equities, etc.)",
      "Interest (from FDs, bonds, etc.)",
      "Capital gains (from stocks, crypto, F&O, mutual funds)",
    ],
  },
  {
  ...
  {
    title: "Foreign Asset or Income Holders",
    description:
  ...
  {
    title: "Charitable and Religious Trusts",
    description:
...
const businessProfessionalIncome = [
  {
    title: "Businesses",
    description:
      "Mandatory if your total sales, turnover, or gross receipts exceed Rs 60 lakh during the financial year.",
  },
  {
    title: "Professionals",
    description:
      "Mandatory if gross receipts exceed Rs 10 lakh during the financial year.",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  An Income Tax Return (ITR) is a form used by taxpayers to
                  report their income details and tax payments to the Income Tax
                  Department. There are seven different ITR forms available for
                  ITR e-filing: ITR 1 through ITR 7. The appropriate form for a
                  taxpayer depends on various factors, including their sources
                  of income, the total amount earned, and the type of taxpayer
                  they are (such as individuals, Hindu Undivided Families
                  (HUFs), companies, etc.). Each taxpayer must accurately
                  complete their income tax filing within the specified deadline
                  to comply with the Income Tax Law.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  financial responsibility. It applies to individuals and
                  entities across various categories and income levels. Below is
                  a clear overview of who must e-file their ITR income tax
                  return in India:
                </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  your return - and the limits vary based on your age and the
                  tax regime chosen.
                </p>
                <p className="text-muted-foreground text-justify">
                  A tax regime refers to the structure under which your income
                  is taxed. As of the latest updates, taxpayers can opt for
                  either the Old Tax Regime, which allows various deductions and
              ...
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  provided the updated income tax slabs for the New Tax Regime
              ...
              <div>
                <p className="text-muted-foreground text-justify mb-4">
                  However, there are other specific circumstances that require
                  you to file ITR, even if your income is below these
                  thresholds:
                </p>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {highValueTransactions.map((item, index) => (
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {businessProfessionalIncome.map((item, index) => (
                    <li key={index}>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  does not fulfil all obligations; timely income tax e-filing in
                  India is also mandatory to avoid penalties. Here's a summary
                  of the key Income tax e-filing last dates or due dates for
                  various categories of taxpayers for the Financial Year (FY)
                  2024-25:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Stay ahead in tax compliance with CACSFinacc Services. Contact
                  us today to streamline your ITR filing process.
                </p>
              </div>
            </div>
