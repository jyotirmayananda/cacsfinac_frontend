...
const incomeLimits = [
  {
    section: "44AD",
    type: "Business",
    presumption: "6% (digital) or 8% (cash) of gross turnover",
    turnover: "₹2 crore",
  },
  {
    section: "44ADA",
    type: "Profession",
    presumption: "50% of gross receipts",
    turnover: "₹50 lakh",
  },
  {
    section: "44AE",
    type: "Transport",
    presumption: "₹1,000 per ton/day per vehicle",
    turnover: "NA",
  },
];
...
const keyAmendments = [
  {
    ...
    description:
      "Taxpayers can now report LTCG up to ₹1.25 lakh under Section 112A directly in ITR-4, provided there are no capital losses to carry forward. This change simplifies the filing process for small investors.",
  },
  {
    title: "Enhanced Deductions and Disclosures:",
    description:
      "Deductions under Sections 80C to 80U must now be selected from a drop-down menu in the e-filing portal, and the exact clause/sub-section must be specified. Income from retirement accounts maintained abroad (Section 89A) has new fields for better relief tracking.",
  },
  {
    title: "Aadhaar Enrollment ID Removed:",
    description:
      "The 28-digit Aadhaar Enrolment ID is no longer accepted. The field now only accepts valid 12-digit Aadhaar Numbers.",
  },
  {
  ...
  {
    title:
      "Enhanced disclosures under presumptive taxation for better compliance tracking",
  },
  {
  ...
  {
    title:
      "Integration with AIS (Annual Information Statement) and Form 26AS to pre-fill data",
  },
  {
    title:
      "VDAs (Crypto Assets) – ITR-4 not applicable if income includes virtual digital assets",
  },
  {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  As the due date for Income Tax Return (ITR) filing approaches,
                  it's crucial for taxpayers to understand the recent updates to
                  ITR-4 (Sugam) for Assessment Year (AY) 2025–26. These changes,
                  introduced by the Central Board of Direct Taxes (CBDT), aim to
                  simplify the filing process for small taxpayers and ensure
                  compliance with the latest tax regulations.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  CACSFinacc Services offers expert ITR-4 filing services to
                  help you navigate the presumptive taxation scheme and ensure
                  accurate, timely, and compliant tax returns.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  applicable to resident individuals, HUFs, and Firms (other
                  than LLPs) who opt for presumptive income scheme under:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Section 44AD – Business income</strong>
                  </li>
                  <li>
                    <strong>
                      Section 44ADA – Professional income (specified
                      professions)
                    </strong>
                  </li>
                  <li>
                    <strong>
                      Section 44AE – Income from goods carriage (transport
                      business)
                    </strong>
                  </li>
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  Not applicable for companies, LLPs, or taxpayers with foreign
                  assets or income.
                </p>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Who Should File ITR-4 for AY 2025-26?
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  However, ITR-4 is not applicable if you:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  compliance for certain individuals and businesses. Under
                  Section 44AA of the Income Tax Act, individuals and businesses
                  engaged in specific activities are typically required to
                  maintain detailed accounting records. However, Sections 44AD,
                  44ADA, and 44AE offer relief to small taxpayers by allowing
                  them to estimate their Income at prescribed rates, reducing
                  the burden of maintaining extensive financial records.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                ...
                <div className="space-y-4 mt-4">
                  <div>
                    ...
                    <p className="text-muted-foreground text-justify">
                      ...
                      (excluding Limited Liability Partnerships) engaged in
                      certain businesses to calculate their Income on an
                      estimated basis, provided they meet specific conditions.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg">Section 44ADA</h3>
                    <p className="text-muted-foreground text-justify">
                      Resident individuals in India who are professionals in
                      fields specified under Section 44AA(1) can use this scheme
                      to estimate their professional Income, subject to certain
                      conditions.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground text-justify">
                      This scheme is applicable to individuals, HUFs, Firms
                      (excluding Limited Liability Partnerships), and other
                      residents or non-residents engaged in the business of
                      plying, leasing, or hiring goods carriages. They can
                      estimate their Income under this scheme, provided they own
                      not more than ten goods carriages during the previous
                      year.
                    </p>
                  </div>
                </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Income Limits Under Presumptive Scheme
                </h2>
                <Table>
                  <TableHeader>
                    <TableRow>
                ...
                <div className="mt-4 space-y-2 text-sm text-muted-foreground">
                  ...
                  <p>
                    When Income is computed on a presumptive basis under
                    sections 44AD, 44AE, or 44ADA, it is presumed to have been
                    calculated after accounting for all allowances,
                    depreciation, losses, or deductions as per the Income-tax
                    Act. However, individuals incurring losses after applying
                    the proviso to sub-section 3 of Section 44AE are required to
                    file ITR-5.
                  </p>
                  <p>
                    If the taxpayer needs to combine the Income of another
                    person, such as a spouse or minor child, with their own
                    Income, the SUGAM form can only be used if the additional
                    Income falls within the specified income categories
                    mentioned above.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  What’s New in ITR-4 for AY 2025-26? (CBDT Updates &
                  Amendments)
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  ITR-4 Filing Process with CACSFinacc
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose CACSFinacc for Your ITR-4 Filing?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
