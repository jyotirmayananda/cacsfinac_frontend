...
const requiredDocs = [
  ...
  { type: "Company", docs: "Certificate of Incorporation, PAN, director’s ID" },
  {
    ...
    docs: "Partnership deed, firm PAN, partners’ ID",
  },
  { type: "Trust/NGO", docs: "Trust deed, registration certificate, PAN" },
  {
    type: "Individuals",
    docs: "PAN, Aadhaar, ownership proof of property (if applicable)",
  },
];
...
const penalties = [
  {
    default: "Failure to apply for TAN:",
    penalty: "₹10,000 under Section 272BB",
  },
  { default: "Not quoting TAN in TDS returns:", penalty: "₹10,000" },
  {
    default: "Late filing of TDS returns:",
    penalty: "₹200 per day (Section 234E)",
  },
  {
    default: "Wrong TAN used in returns:",
    penalty: "Treated as invalid submission",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  Tax Deduction and Collection Account Number (TAN) is a
                  10-digit alphanumeric code issued by the Income Tax Department
                  of India. It is mandatory for entities responsible for
                  deducting or collecting tax at source (TDS or TCS) under
                  Section 203A of the Income Tax Act, 1961.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  It is mandatory for all deductors/collectors to quote TAN on
                  TDS returns, challans, and certificates. Non-compliance
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  10-digit alphanumeric code required for entities that deduct
                  or collect tax at source (TDS/TCS). It is essential to quote
                  TAN on all TDS-related documents.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  TAN is crucial for filing TDS returns and depositing TDS to
                  the government. Failure to obtain a TAN or quoting an
                  incorrect TAN can result in penalties and non-processing of
                  TDS returns.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-2">
                  <strong>TAN is compulsory for:</strong>
                </p>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Even freelancers or individuals buying property above ₹50
                  lakhs may need TAN for TDS on property transactions.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  TAN Registration – What’s New for AY 2025-26?
                </h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  The documents required for TAN application vary based on the
                  applicant type:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {requiredDocs.map((item, index) => (
                    <li key={index}>
                      <strong>{item.type}:</strong> {item.docs}
                    </li>
                  ))}
                </ul>
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> Application must be submitted in Form
                  49B (online or offline).
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  TAN Registration for Non-Residents
                </h2>
                <p className="text-muted-foreground text-justify">
                  NRIs and foreign entities engaged in business or transactions
                  in India are also required to obtain TAN for TDS on payments
                  like rent, professional fees, and interest income.
                </p>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  How CACSFinacc Simplifies Your TAN Registration
                </h2>
                <ol className="space-y-3 list-decimal pl-5 text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  Register your TAN effortlessly with CACSFinacc Services. Our
                  experts ensure a smooth, hassle-free registration and TDS
                  filing process, keeping you compliant with the latest tax
                  laws.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
