            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  ...
                  the ITR forms and their procedures. Among these forms, ITR-1,
                  often referred to as Sahaj, holds particular significance.
                  ITR1 (Sahaj) is designed for individuals with an income of up
                  to Rs.50 lakhs, making it applicable to most salaried
                  individuals.
                </p>
                <p className="text-muted-foreground text-justify mt-4">
                  At CACSFinacc Services, we specialize in providing efficient
                  and accurate ITR-1 Return Filing services for individuals with
                  straightforward income sources. Our team is well-versed with
                  the latest amendments introduced for the Assessment Year
                  2024-25, ensuring complete compliance and hassle-free
                  submission.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ITR-1, also known as Sahaj, is a simplified Income Tax Return
                  form for individuals who have income from:
                </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ITR-1, also known as Sahaj, is applicable for resident
                  individuals (other than not ordinarily resident) who have:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  {whoShouldFile.map((item, index) => (
                    <li key={index}>{item}</li>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Total income should not exceed ₹50 lakh during the financial
                  year.
                </p>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Our ITR-1 Filing Services Include:
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Our ITR-1 Return Filing Services
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                  At CACSFinacc Services, we offer comprehensive solutions to
                  manage your ITR-1 obligations:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
