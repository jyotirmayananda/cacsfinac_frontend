            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  At CACSFinacc Services, we understand the importance of timely
                  and accurate filing of Employees' State Insurance (ESI)
                  Returns. ESI is a self-financed social security scheme under
                  the Employees' State Insurance Act, 1948, providing medical,
                  disability, maternity, and unemployment benefits to employees
                  earning ₹21,000 or less per month (₹25,000 for disabled
                  employees). Compliance with ESI regulations is crucial for
                  businesses to avoid legal penalties and ensure employee
                  welfare.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ESI Return Filing is a mandatory requirement for employers
                  registered under the ESI Act. It involves the submission of
                  monthly and half-yearly returns that detail:
                </p>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Our ESI Return Filing Services Include:
                </h2>
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold font-headline text-primary">
                  Key Updates for Financial Year (FY) 2025–26
                </h2>

                <div>
                  <h3 className="font-semibold text-lg">
                    1. Revised ESI Contribution Rates
                  </h3>
                  <p className="text-muted-foreground text-justify mt-2 mb-2">
                    The ESI contribution rates remain unchanged for FY 2025–26:
                  </p>
                  <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                    <li>
                      <strong>Employer's Contribution:</strong> 3.25% of the
                      employee's wages
                    </li>
                    <li>
                      <strong>Employee's Contribution:</strong> 0.75% of the
                      wages
                    </li>
                  </ul>
                  <p className="text-muted-foreground text-justify mt-2">
                    These contributions are mandatory for establishments
                    employing 10 or more persons earning wages up to ₹21,000 per
                    month.
                  </p>
                </div>
                ...
                <div>
                  <h3 className="font-semibold text-lg">
                    2. Updated Filing Deadlines
                  </h3>
                  <p className="text-muted-foreground text-justify mt-2 mb-2">
                    Timely filing of ESI returns is essential to maintain
                    compliance. The due dates are as follows:
                  </p>
                  <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                    <li>
                      <strong>Monthly ESI Contribution Payment:</strong> 15th of
                      the following month. For instance, contributions for April
                      2025 are due by 15th May 2025.
                    </li>
                    <li>
                      <strong>Half-Yearly ESI Return Filing:</strong> Due by
                      11th May and 11th November each year.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-justify mt-2 mb-2">
                    Failure to adhere to ESI payment and filing deadlines can
                    result in:
                  </p>
                  <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                  ...
                  <p className="text-muted-foreground text-justify mt-2">
                    These penalties underscore the importance of timely
                    compliance to avoid financial and legal repercussions.
                  </p>
                </div>
              </div>
              ...
              <div>
                <p className="text-muted-foreground text-justify font-semibold">
                  At CACSFinacc Services, we offer comprehensive solutions to
                  manage your ESI obligations:
                </p>
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  Ensure seamless ESI compliance with CACSFinacc Services.
                  Contact us today to streamline your ESI return filing process.
                </p>
              </div>
            </div>
