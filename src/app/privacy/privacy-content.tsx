        ...
        <div className="mt-8 bg-secondary p-6 md:p-10 rounded-2xl shadow-sm">
          <div className="prose max-w-none prose-headings:font-headline prose-headings:text-primary prose-a:text-primary hover:prose-a:underline prose-strong:text-foreground">
            ...
            <div className="text-justify space-y-4">
              ...
              <p>
                CACS FINACC is committed to protecting the privacy and
                confidentiality of individuals and businesses interacting with
                our platform. This Privacy Policy outlines how we collect,
                process, use, disclose, and safeguard your personal and
                financial data in accordance with applicable Indian laws and
                allied regulations. This policy applies to all users of our
                website, services, contact forms, and communications.
              </p>
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      PAN, Aadhaar (only if required), and other identification
                      documents
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      Income statements, GST details, bank statements, invoices
                    </li>
                    <li>
                      ROC compliance documents, tax filings, audit reports
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      Company incorporation details, statutory filings, director
                      data
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      IP address, device/browser data, geolocation, pages
                      visited
                    </li>
              ...
              <ul>
                <li>
                  <strong>Consent:</strong> For communication, updates, and
                  onboarding
                </li>
                <li>
                  <strong>Contractual necessity:</strong> For delivering
                  professional services
                </li>
                <li>
                  <strong>Legal obligation:</strong> For compliance with tax and
                  regulatory laws
                </li>
                <li>
                  <strong>Legitimate interest:</strong> To improve services and
              ...
              <ul>
                <li>
                  Providing chartered accountancy, taxation, and legal
                  compliance services
                </li>
                <li>Filing of GST, ITR, TDS, and ROC returns</li>
                <li>
                  Conducting audits, reconciliations, and statutory
                  verifications
                </li>
              ...
              <p>
                ...
                purposes outlined in this policy or as required by law (e.g., 8
                years under Indian tax laws).
              </p>

              <h2 className="text-2xl">7. Disclosure of Information</h2>
              <p>
                Your data may be disclosed to the following, only when
                necessary:
              </p>
              <ul>
                <li>
                  Authorized regulatory/government bodies (e.g., GSTN, MCA,
                  Income Tax Department)
                </li>
                <li>
                  Authorized third-party partners under strict confidentiality
                  (e.g., cloud storage, digital signature agencies)
                </li>
                <li>
                  Legal professionals, if required during dispute resolution
                </li>
                <li>
              ...
              <h2 className="text-2xl">
                8. Use of Cookies and Analytics Tools
              </h2>
              <p>
              ...
              <ul>
                ...
                <li>
                  Request erasure of your data, unless prohibited by statutory
                  recordkeeping
                </li>
              </ul>
              ...
              <p>
                ...
                (e.g., payment gateways, digital signature platforms). We are
                not responsible for their privacy practices and recommend
                reviewing their privacy policies before engagement.
              </p>
