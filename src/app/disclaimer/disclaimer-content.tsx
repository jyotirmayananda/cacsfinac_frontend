        ...
        <div className="mt-8 bg-secondary p-6 md:p-10 rounded-2xl shadow-sm">
          <div className="prose max-w-none prose-headings:font-headline prose-headings:text-primary prose-a:text-primary hover:prose-a:underline prose-strong:text-foreground">
            ...
            <div className="text-justify space-y-4">
              ...
              <p>
                The information contained on <b>www.cacsfinaccservices.com</b>{" "}
                is for general informational purposes only. CACS FinAcc
                Services™ strives to ensure that the information is accurate and
                up-to-date, but makes no warranties or representations regarding
                the completeness, accuracy, or reliability of the content. Any
              ...
              <p>
                The content is not intended to replace professional advice.
                Please consult us for advice specific to your circumstances.
              </p>
              ...
              <p>
                ...
                Unauthorised copying, reproduction, distribution, or
                modification of any Website content, including downloadable
                materials, is prohibited without prior written consent.
              </p>

              <h3>3. Fair Use</h3>
              <p>
                Limited fair use of content for personal, non-commercial
                purposes is permitted, provided proper attribution is given to
                CACS FinAcc Services™.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  that you are the rights holder or authorised to act on their
                  behalf
                </li>
              </ul>
            </div>
