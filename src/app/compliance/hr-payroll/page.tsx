...
const complianceChecklist = [
  {
    item: "Salary Calculation & Payslip",
    frequency: "Monthly",
    rule: "As per employment agreement",
  },
  {
    item: "TDS Deduction & Deposit",
    frequency: "Monthly",
    rule: "By 7th of following month (Section 192)",
  },
  {
    item: "TDS Return (Form 24Q)",
    frequency: "Quarterly",
    rule: "31st Jul / 31st Oct / 31st Jan / 31st May",
  },
  {
    item: "Form 16 Issuance",
    frequency: "Annual",
    rule: "By 15th June 2025 for FY 2024-25",
  },
  {
    item: "PF Contribution (EPF)",
    frequency: "Monthly",
    rule: "By 15th of following month",
  },
  {
    item: "ESI Contribution",
    frequency: "Monthly",
    rule: "By 15th of following month",
  },
  {
    item: "Professional Tax (PT)",
    frequency: "Monthly/Quarterly",
    rule: "Varies by State (e.g., 20th monthly in MH)",
  },
  {
    item: "Labour Welfare Fund (LWF)",
    frequency: "Half-Yearly",
    rule: "June & December (varies by State)",
  },
  {
    item: "Leave & Attendance Record",
    frequency: "Ongoing",
    rule: "Maintain for 5 years minimum",
  },
  {
    item: "Employment Agreements",
    frequency: "At hiring",
    rule: "Signed & stamped at onboarding",
  },
];
...
const payrollInclusions = [
  {
    ...
    inclusions: "Salary computation, bonuses, arrears",
  },
  {
    area: "TDS on Salaries (Section 192)",
    inclusions: "Calculation, deduction, Form 24Q, Form 16",
  },
  {
    area: "Provident Fund (PF)",
    inclusions: "Employee + Employer contribution, ECR filing",
  },
  {
    area: "Employee State Insurance (ESI)",
    inclusions: "Deductions, return filing",
  },
  { area: "Professional Tax", inclusions: "State-wise deduction and payment" },
  {
    area: "Gratuity & Bonus",
    inclusions: "Compliance with Bonus Act and Gratuity Act",
  },
  {
    area: "Labour Welfare Fund",
    inclusions: "Deduction/payment as per state rules",
  },
  {
    area: "Leave Encashment, LTA, HRA",
    inclusions: "Tax calculation and declaration verification",
  },
  {
    area: "Employment Registers",
    inclusions: "Attendance, wage, muster rolls (for audit/inspection)",
  },
];
...
const businessCategories = [
  {
    category: "Startups",
    considerations:
      "Payroll outsourcing, ESOP taxation, flexible CTC structures",
  },
  {
    category: "SMEs/Manufacturing",
    considerations:
      "Shift allowances, wage code readiness, shop floor compliance",
  },
  {
    category: "IT/ITES",
    considerations: "TDS on remote employees, hybrid work policy formalization",
  },
  {
    category: "Contract Workforce",
    considerations: "CLRA registration, monthly contractor ECR/ESI follow-up",
  },
];
...
const nonComplianceConsequences = [
  {
    area: "TDS on Salary",
    penalty: "Interest @ 1.5% p.m. + ₹200/day late fee + penalty u/s 271H",
  },
  {
    area: "EPF / ESI Non-payment",
    penalty: "Damages up to 25% + interest + prosecution in extreme cases",
  },
  {
    area: "Professional Tax Default",
    penalty: "₹1,000 – ₹5,000 per month (varies by State)",
  },
  {
    area: "Labour Law Violation",
    penalty:
      "₹10,000 – ₹1,00,000 + imprisonment (depending on Act and severity)",
  },
...
const dueDates = [
  ...
  {
    compliance: "TDS Return (Form 24Q, Q1–Q4)",
    dueDate: "31st Jul / 31st Oct / 31st Jan / 31st May",
  },
  ...
  { compliance: "ESI Payment", dueDate: "15th of every month" },
  {
    ...
    dueDate: "Varies state-wise (monthly/annually)",
  },
  {
    compliance: "Bonus & Gratuity Payment",
    dueDate: "As per respective Acts within prescribed timelines",
  },
];
...
const howWeSimplify = [
  {
    ...
    description: "Salary, tax, bonus, reimbursements, and payslip generation",
  },
  {
    title: "TDS Computation & Filing (24Q)",
    description:
      "Monthly TDS calculation and quarterly returns with Form 16 issuance",
  },
  {
    title: "PF, ESI & PT Filing",
    description:
      "Monthly challan creation, payment, and compliance documentation",
  },
  {
    title: "Labour Law Registers & Returns",
    description: "Maintenance of wage, muster, bonus, and overtime registers",
  },
  {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  business, and CACSFinacc simplifies this process with an
                  all-in-one, cloud-based payroll software designed to
                  streamline employee management systems, payroll processing, PF
                  and ESI compliance, and automated salary tax calculation.
                  Whether you're a startup seeking affordable payroll software
                  or an enterprise requiring advanced HR management software
                  features, our solution ensures accuracy, efficiency, and full
                  compliance with Indian labour laws, making payroll seamless
                  and hassle-free.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  HR & Payroll Compliance involves the accurate processing of
                  employee salaries, deductions, benefits, and reporting in
                  accordance with applicable labour laws, tax regulations, and
                  statutory frameworks in India.
                </p>
                <p className="text-muted-foreground text-justify mb-2">
                  For any organization—whether a startup, SME, or large
                  enterprise—non-compliance with payroll rules can result in:
                </p>
                ...
                <p className="text-muted-foreground text-justify">
                  AY 2025-26 has brought several important amendments in TDS,
                  PF, ESI, and gratuity thresholds, making timely payroll
