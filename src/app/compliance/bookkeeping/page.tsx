          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground text-justify mb-4">
                Accounting is the process of classifying, interpreting, and
                summarizing financial data to assess the financial health of a
                business. Bookkeeping, on the other hand, involves the accurate
                recording of all financial transactions on a daily basis.
              </p>
              <p className="text-muted-foreground text-justify mb-8">
                Together, they form the foundation for effective financial
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground text-justify mb-4">
                    Accounting and bookkeeping form the financial backbone of
                    any organization. Accurate and timely records are not just
                    statutory requirements under the Income Tax Act, 1961, and
                    GST laws, but also crucial for:
                  </p>
                  ...
                  <p className="text-muted-foreground text-justify mt-4">
                    Whether you’re a startup, MSME, partnership, LLP, company,
                    or NPO, outsourced, tech-enabled, and CA-reviewed accounting
                    ensures you remain compliant and audit ready.
                  </p>
                </div>
              ...
              <div className="mt-12 p-6 bg-primary/10 rounded-lg">
                ...
                <p className="text-muted-foreground mt-2">
                  Don’t let mismanaged records hold you back. With CACSFinacc,
                  you get a dedicated CA-led accounting team, cloud-enabled
                  platforms, and regulatory-proof financials—tailored to your
