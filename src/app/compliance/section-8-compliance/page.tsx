...
const complianceRequirements = [
  ...
  {
    area: "Audit & Financials",
    filings: "Form 10B/10BB, Annual Accounts Audit",
  },
  { area: "TDS Compliance", filings: "24Q/26Q filings and payment" },
  { area: "CSR Reporting", filings: "CSR-2 if applicable" },
  {
    area: "Foreign Investment Reporting",
    filings: "FC-GPR/FLA (if FDI received)",
  },
  {
    area: "FCRA Filing",
    filings: "FC-4, FC-6 (if registered for foreign contributions)",
  },
];
...
const postIncorporationCompliance = [
  {
    compliance: "Commencement Certificate (INC-20A)",
    timeline: "Within 180 days of incorporation",
  },
  {
    compliance: "Appointment of Auditor (ADT-1)",
  ...
  {
    compliance: "CSR-1 & CSR-2 Filing",
    timeline: "Annually (for CSR-recipient entities)",
  },
  {
    compliance: "Tax Return (ITR-7)",
    timeline: "By 31st October (if audited)",
  },
  {
    compliance: "Tax Audit (if applicable)",
    timeline: "If receipts > ₹1 crore",
  },
];
...
const taxBenefits = [
  {
    ...
    benefit: "Exemption on income used for charitable/religious purposes",
  },
  {
    provision: "Section 12A",
    benefit: "Registration for tax exemption eligibility",
  },
  {
    provision: "Section 80G",
    benefit: "Allows donors to claim 50%-100% deduction on contributions",
  },
  {
    provision: "GST",
    benefit:
      "No registration needed if aggregate turnover < ₹20 lakhs (₹10 lakhs for NE states)",
  },
  {
    provision: "FCRA",
    benefit:
      "Permission for foreign funding after 3 years of activity & eligibility",
  },
];

const penalties = [
  {
    nonCompliance: "Delay in Annual Filings",
    penalty: "₹100 per day per form (AOC-4 / MGT-7)",
  },
  {
    nonCompliance: "Violation of Section 8 conditions",
    penalty:
      "Revocation of license + ₹10 lakh fine + prosecution under Companies Act",
  },
  {
    nonCompliance: "Missed CSR reporting",
    penalty: "₹1 lakh penalty on company + ₹50,000 on officer in default",
  },
  {
    nonCompliance: "Not renewing 12A/80G (after expiry)",
    penalty: "Loss of tax exemption status & donor benefit",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  A Section 8 Company is a non-profit entity incorporated under
                  Section 8 of the Companies Act, 2013, with the primary
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  Such companies apply profits or income toward their cause and
                  are prohibited from distributing dividends to members. Section
                  8 Companies are ideal for NGOs, social enterprises, trusts,
                  foundations, and CSR arms of corporates.
                </p>
                <p className="text-muted-foreground text-justify">
                  A Section 8 Company enjoys tax benefits, enhanced credibility,
                  and is governed by stricter compliance protocols compared to
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  <strong>Note:</strong> Non-compliance may result in loss of
                  tax exemption, penalties, or cancellation of license under
                  Section 8.
                </p>
              </div>
