...
const whoMustFile = [
  {
    entity: "Banks & Co-operative Banks",
    examples: "Deposits, payments, credit card bills",
  },
  { entity: "Post Offices", examples: "Savings and fixed deposits" },
  {
    entity: "Companies issuing shares/debentures",
    examples: "Buy-back, allotment, etc.",
  },
  { entity: "Mutual Funds / AMC", examples: "Units purchased or sold" },
  {
    entity: "Registrar/Sub-Registrar",
    examples: "Purchase or sale of immovable property",
  },
  {
    entity: "NBFCs and Institutions",
    examples: "Loans or credit aggregating specified thresholds",
  },
  {
    entity: "Professionals / Traders / Sellers",
    examples: "If high-value transactions recorded in books",
  },
];
...
const transactionsToReport = [
  ...
  {
    type: "Credit card bill payment (any mode)",
    threshold: "Above ₹10,00,000",
  },
  {
    type: "Sale/purchase of immovable property",
    threshold: "₹30,00,000 or more",
  },
  {
    type: "Cash receipt for sale of goods/services",
    threshold: "Above ₹2,00,000",
  },
  {
    type: "Investment in mutual funds, bonds, shares",
    threshold: "₹10,00,000 or more",
  },
...
const penalties = [
  {
    nonCompliance: "Not filing SFT (Form 61A)",
    penalty: "₹500/day (up to ₹1,00,000)",
  },
  { nonCompliance: "Wrong or incomplete filing", penalty: "₹50,000" },
  {
    nonCompliance: "Non-response to notice under Section 285BA(5)",
    penalty: "Additional ₹1,000/day",
  },
];
...
const howWeHelp = [
  ...
  {
    title: "Transaction Review & PAN Mapping",
    description:
      "Match transactions with client PANs and categorize under Rule 114E",
  },
  {
    title: "Form 61A Preparation & Validation",
    description:
      "Prepare XML in correct schema using SFT utility and validate against technical errors",
  },
  {
    title: "Online Submission via Reporting Portal",
    description: "Upload the report and generate Acknowledgement Number",
  },
  {
    title: "Post Filing Compliance Support",
    description:
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  SFT (Statement of Financial Transactions), formerly known as
                  Annual Information Return (AIR), is a report filed by
                  specified entities under Section 285BA of the Income Tax Act,
                  1961, to the Income Tax Department disclosing high-value
                  financial transactions undertaken by individuals and
                  businesses.
                </p>
                <p className="text-muted-foreground text-justify mb-4">
                  It plays a critical role in income tax surveillance,
                  profiling, and compliance via the Annual Information Statement
                  (AIS) and Form 26AS of taxpayers.
                </p>
                <p className="text-muted-foreground text-justify">
                  SFT filing is not a tax return but a compliance return. It
                  must be filed annually by specific persons/entities
                  responsible for registering or recording such high-value
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> Even a single transaction crossing the
                  prescribed limit triggers SFT reporting.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>31st May 2025</strong> for Financial Year ending
                    31st March 2025
                    <ul className="list-disc pl-5 mt-2">
                      <li>
                        Filed using <strong>Form 61A</strong> through the{" "}
                        <Link
                          href="https://report.insight.gov.in"
                          target="_blank"
                      ...
                      <li>
                        Entities must register separately on the Reporting
                        Portal (different from income tax portal)
                      </li>
                    </ul>
                  </li>
                </ul>
