...
const itrForms = [
  {
    category: "Business income under presumptive scheme (Sec 44AD/44ADA)",
    form: "ITR 4",
  },
  {
    category: "Business/profession with audit or regular books",
    form: "ITR 3",
  },
];
...
const gstRegistrationConditions = [
  ...
  {
    condition: "Monthly/Quarterly Returns:",
    items: [
...
const booksOfAccountsConditions = [
  ...
  {
    condition: "Must maintain:",
    items: [
      "cash book, ledgers, sales/purchase register, bank book, journal, etc.",
    ],
  },
];
...
const regulatoryUpdates = [
  {
    title: "Higher Tax Audit Threshold",
    items: [
  ...
  {
    title: "Revised Presumptive Scheme",
    items: [
...
const annualChecklist = [
  {
    ...
    description:
      "ITR-3/ITR-4 for business income under normal/presumptive scheme",
    dueDate: "31st July / 31st Oct (if audit)",
  },
  {
    compliance: "Tax Audit (if applicable)",
    description: "Audit under Sec. 44AB for high-turnover businesses",
    dueDate: "30th September 2025",
  },
  {
    compliance: "Advance Tax",
    description: "Required if tax liability exceeds ₹10,000",
    dueDate: "Quarterly (15th Jun/Sept/Dec/Mar)",
  },
  {
    compliance: "TDS Payment",
    description: "TDS deducted must be deposited monthly",
    dueDate: "By 7th of next month",
  },
  {
    compliance: "TDS Return Filing",
    description: "Quarterly filing for deducted TDS (24Q/26Q)",
    dueDate: "31st July, Oct, Jan, May",
  },
  {
    compliance: "GST Return Filing",
    description: "GSTR-1 and GSTR-3B monthly/quarterly based on turnover",
    dueDate: "11th and 20th of every month",
  },
  {
    compliance: "GST Annual Return",
    description: "GSTR-9 (if turnover exceeds ₹2 Crores)",
    dueDate: "31st December 2025",
  },
  {
    compliance: "Books of Account",
    description:
      "Must be maintained for 6 years (if turnover > ₹25 lakhs or income > ₹2.5 lakhs)",
    dueDate: "Ongoing",
  },
];
...
const proprietorPlans = [
  ...
  {
    title: "Growth Plan",
    description: "Audit + GST + Full TDS + Advance Tax Calculation",
  },
  {
    title: "Premium Plan",
    description: "Monthly Bookkeeping + Virtual CFO + MIS Reports",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  A sole proprietorship in India is the most basic business
                  setup, where a single individual owns and runs the business.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  ...
                  business in India where an individual owns, operates, and
                  manages the entire business. Though it offers minimal
                  regulatory formalities, the owner must still comply with all
                  tax and statutory requirements.
                </p>
                <p className="text-muted-foreground text-justify">
                  Even if your business is unregistered or operating under your
                  personal PAN, you are still legally obligated to file taxes
                  and maintain books of account if income crosses prescribed
                  thresholds.
                </p>
              </div>
                ...
                <ol className="space-y-6 list-decimal pl-5">
                  <li>
                    ...
                    <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-2">
                      <li>
                        Tax slabs applicable as per individual taxation regime
                        (Old/New)
                      </li>
                      <li>
                        Option to opt for presumptive taxation if turnover ≤ ₹2
                        crore (business) or ₹50 lakh (profession)
                      </li>
                      <li>
                        Books of accounts and audit mandatory if income/turnover
                        exceeds limits
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-2">
                      {taxAuditTriggers.map((item, index) => (
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-2">
                      {tdsComplianceTasks.map((item, index) => (
                        <li key={index}>{item}</li>
                      ))}
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-2">
                      {advanceTaxConditions.map((item, index) => (
                        <li key={index}>{item}</li>
                      ))}
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-2">
                      <li>
                        Applicable in states like Maharashtra, Karnataka, West
                        Bengal, etc.
                      </li>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  As per the Finance Act, 2024 and updated provisions effective
                  for Assessment Year 2025-26, proprietorships must follow:
                </p>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                  <li>
                    Taxed under individual slab rates (no separate business tax
                    rate)
                  </li>
                  <li>
                    Eligible for standard deductions, Section 80C to 80U
                    deductions
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  <strong>Note:</strong> Under the New Tax Regime (Section
                  115BAC), revised slab benefits apply.
                </p>
              </div>
