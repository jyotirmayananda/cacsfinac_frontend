...
const cfoServiceFeatures = [
  {
    ...
    description:
      "We help you define long-term goals, optimize resource allocation, and guide your business towards sustainable profitability.",
  },
  {
    title: "Cash Flow & Budget Management",
    description:
      "Real-time monitoring, forecasting, and control of your cash flow—so you never run out of runway.",
  },
  {
    title: "Management Information Systems (MIS)",
    description:
      "Customized MIS reports, KPIs, and dashboards for founders, investors, and stakeholders.",
  },
  {
    title: "Investor-Ready Financials",
    description:
      "Ensure due diligence-ready financials for fundraising, mergers, or scale-up investments.",
  },
  {
    title: "Compliance & Risk Advisory",
    description:
      "Stay ahead of regulatory risks with timely GST, TDS, and ROC compliance tracking and execution.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground text-justify mb-6">
                In today's fast-moving business environment, startups and SMEs
                need more than just accounting support—they need strategic
                financial insight, cost control, and cash flow clarity.
                CACSFinacc's Virtual CFO services are designed to deliver
                expert-level financial management without the full-time cost of
                a traditional CFO.
              </p>
              <p className="text-muted-foreground text-justify mb-8">
                We partner with founders, solopreneurs, and scaling enterprises
                to provide data-driven insights, investor-ready reports, and
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    Why Choose CACSFinacc as Your Virtual CFO?
                  </h2>
              ...
              <div className="mt-12">
                <p className="text-lg font-semibold">
                  Ready to scale smart? Let's transform your numbers into
                  decisions.
                </p>
                <Button asChild size="lg" className="mt-4">
                  <Link href="https://wa.me/9591633648" target="_blank">
