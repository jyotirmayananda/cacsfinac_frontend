...
const complianceAreas = [
  {
    area: "Business Model Mapping",
    details:
      "Match proposed activities with GST codes, NIC codes, licensing laws",
  },
  {
    area: "Entity Structuring",
    details: "Choose between Proprietorship, LLP, Pvt. Ltd., or OPC",
  },
  {
    area: "Startup India/DPIIT Eligibility",
    details: "Business innovation certification and tax holiday planning",
  },
  {
    area: "Income Tax Strategy",
    details: "Presumptive vs. normal taxation, depreciation planning",
  },
  {
    area: "ROC & MCA Mapping",
    details:
      "Alignment of authorized capital, shareholder funding, MOA activities",
  },
  {
    area: "GST Registration & Mapping",
    details: "HSN/SAC codes, reverse charge mechanism, e-invoicing thresholds",
  },
  {
    area: "FEMA/FDI Alignment",
    details: "If foreign investment or overseas expansion is involved",
  },
  {
    area: "Bankable Financial Forecasts",
    details: "Projections aligned with RBI, MCA & Income Tax compliance",
  },
  {
    area: "TDS/TCS & Payroll Readiness",
    details: "Applicable sections under 194, 194C, 192, PF, ESI, PT",
  },
  {
    area: "Industry-Specific Licenses",
    details: "FSSAI, IEC, MSME Udyam, Labour Registration, etc.",
  },
];
...
const keyMilestones = [
  {
    ...
    compliances:
      "Business plan legal vetting, MCA name reservation, licensing matrix",
  },
  {
    stage: "Post-Incorporation",
    compliances:
      "PAN, TAN, GST, MSME, ESIC/PF, bank account setup, MCA filings",
  },
  {
    stage: "First 6 Months",
    compliances: "Monthly GST, TDS, accounting, payroll setup, Form 26Q/24Q",
  },
  {
    stage: "First Financial Year",
    compliances:
      "Audit, ITR filing, Form MGT-7, AOC-4 (if company), SFT/Form 61A if applicable",
  },
];
...
const ourSuite = [
  {
    title: "Entity Structuring & Registration",
    description:
      "Choose and register the best-fit business structure (Pvt Ltd, LLP, OPC)",
  },
  {
    title: "Startup Business Plan Preparation",
    description:
      "3–5 year financials, market research, breakeven analysis, and funding roadmap",
  },
  {
    title: "ROC & MCA Compliance",
    description:
      "Annual returns, director KYC, statutory registers, and AGM/board meeting guidance",
  },
  {
    title: "Tax Forecasting & Registration",
    description:
      "PAN, TAN, GST, TDS, PF/ESI registrations with mapped tax outflows",
  },
  {
    title: "Investor & FDI Compliance",
    description:
      "FC-GPR/FDI reporting via RBI FIRMS, valuation support, and share capital planning",
  },
  {
    title: "HR & Payroll Setup",
    description:
      "Automated payroll, PF/ESI registration, payslip generation, and Form 24Q",
  },
  {
    title: "Compliance Calendar Setup",
    description:
      "Auto-reminders for TDS, GST, ROC filings, and advance tax dues",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground text-justify mb-4">
                ...
                potential investors and stakeholders. Whether you're a startup
                seeking your first round of funding or an established business
                looking to expand, having a well-structured business plan is
                critical for success.
              </p>

              <h2 className="text-2xl font-bold font-headline mt-8 mb-4 text-primary">
                What is a Business Plan?
              </h2>
              <p className="text-muted-foreground text-justify mb-4">
                A business plan is a formal document that defines your business
                objectives, strategies, market research, financial projections,
                and more. It serves as a guiding document for securing funding
                and setting internal goals and benchmarks. In simple terms, a
                business plan offers a complete overview of your business model,
                from market analysis to long-term vision.
              </p>
              ...
              <p className="text-muted-foreground text-justify mb-4">
                For startups and established businesses alike, this document is
                invaluable for short-term and long-term decision making. It also
                helps keep the business on track, ensuring that the team remains
                aligned with the company’s objectives and growth strategy.
              </p>
              <ul className="space-y-2 pl-5 list-disc text-muted-foreground mb-4">
              ...
              <p className="text-muted-foreground text-justify mb-8">
                Whether you're working on a startup business plan or need to
                update your plan for a growing business, a well crafted business
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    What Does Business Plan Compliance Cover?
                  </h2>
                  <Table>
                    <TableHeader>
                      <TableRow>
                ...
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    Key Compliance Milestones for Early-Stage Businesses
                  </h2>
                  <Table>
                    <TableHeader>
                      <TableRow>
                ...
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    Who Needs Business Plan Compliance?
                  </h2>
                  <p className="font-semibold text-muted-foreground">
                    Startups, MSMEs, and established businesses looking to:
                  </p>
                  ...
                  <p className="text-muted-foreground text-justify">
                    Business plan compliance is essential for credibility,
                    regulatory clearance, and long-term scalability.
                  </p>
                </div>

                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    Key Components of Business Plan Compliance
                  </h2>
                ...
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    CACSFinacc’s Business Plan Compliance Suite
                  </h2>
                  <ol className="space-y-4 list-decimal pl-5">
                ...
                <div>
                  <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                    How CACSFinacc Ensures Business Plan Compliance
                  </h2>
