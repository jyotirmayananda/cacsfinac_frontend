...
const fdiForms = [
  {
    form: "FC-GPR",
    purpose: "Issue of shares by Indian company to foreign investor",
    timeline: "Within 30 days from issue",
  },
  {
    form: "FC-TRS",
    purpose: "Transfer of shares between resident and non-resident",
    timeline: "Within 60 days of transfer",
  },
  {
    form: "LLP(I)",
    purpose: "Receipt of capital contribution from non-resident into LLP",
    timeline: "Within 30 days from receipt",
  },
  {
    form: "LLP(II)",
    purpose: "Disinvestment or transfer of capital in LLP",
    timeline: "Within 60 days of transfer",
  },
  {
    form: "CN (Convertible Notes)",
    purpose: "Issue or transfer of convertible notes to foreign investors",
    timeline: "Within 30 days",
  },
  {
    form: "ESOP Reporting",
    purpose: "Allotment of ESOPs to non-resident employees/directors",
    timeline: "Within 30 days of allotment",
  },
  {
    form: "DRR Reporting",
    purpose: "Downstream investment by Indian entity having FDI",
    timeline: "Within 30 days of investment",
  },
];
...
const penalties = [
  {
    default: "Delay in filing FC-GPR/FC-TRS",
    penalty: "Up to ₹5,000 per day and prosecution under compounding",
  },
  {
    default: "Wrong/incomplete filings",
    penalty: "Summon from RBI, compounding fee, inspection of books",
  },
  {
    default: "Non-reporting of ESOP/Bonus",
    penalty: "₹10,000 + ₹1,000 per day thereafter",
  },
];
...
const ourServices = [
  {
    title: "End-to-End FDI Structuring & Advisory",
    description:
      "We help structure the investment to remain FEMA & Income Tax compliant",
  },
  {
    title: "FIRMS Portal Registration & Entity Setup",
    description:
      "Register Business User, link entity, and manage DSC-based login for filing",
  },
  {
    title: "Preparation & Filing of FC-GPR / FC-TRS / CN / LLP Forms",
    description:
      "Draft, validate, and submit forms through RBI FIRMS portal with tracking",
  },
  {
    title: "Valuation Report and KYC Coordination",
    description:
      "Liaise with SEBI merchant banker or CA for compliance-ready valuation",
  },
  {
    title: "FLA Return Filing",
    description:
      "Annual reporting of foreign liabilities to RBI, even if no new investment",
  },
  {
    title: "Penalty Resolution and FEMA Compounding Support",
    description:
      "If forms were missed, we handle penalty waivers or compounding applications with RBI",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  <strong>Foreign Direct Investment (FDI)</strong> is the
                  capital investment made by a foreign individual or entity into
                  an Indian company. While FDI is permitted under both automatic
                  and approval routes, all investments must be reported to the
                  Reserve Bank of India (RBI) within prescribed timelines.
                </p>
                <p className="text-muted-foreground text-justify mb-4">
                  Under the{" "}
                  <strong>Foreign Exchange Management Act (FEMA), 1999</strong>{" "}
                  and RBI's Foreign Investment Reporting and Management System
                  (FIRMS), companies receiving FDI are required to file multiple
                  forms depending on the nature and stage of the investment.
                  Failure to file FDI returns accurately or within time may lead
                  to penalties under FEMA and can delay further foreign
                  investments.
                </p>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Who Must File FDI Returns?
                </h2>
                <p className="text-muted-foreground mb-4">
                  Any Indian entity (Private Ltd, Public Ltd, LLP) that receives
                  foreign investment under the automatic or government route
                  must file:
                </p>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Types of FDI Filing & Applicable Forms
                </h2>
                <Table>
                  <TableHeader>
                    <TableRow>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  <strong>Compounding under FEMA</strong> is now mandatory in
                  case of reporting delays.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Timely FDI Filing Matters
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  CACSFinacc’s FDI Filing Services
                </h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Choose CACSFinacc for FDI Filing?
                </h2>
                <ul className="space-y-3 text-muted-foreground">
