...
const rocFilingsData = [
  {
    form: "AOC-4",
    purpose: "Filing of audited financials",
...
const complianceCalendar = [
  {
    ...
    description: "Audit of financials by Chartered Accountant",
    dueDate: "30th September 2025",
  },
  {
    compliance: "Income Tax Return (ITR-6)",
    description: "Return filing for company (not under presumptive taxation)",
    dueDate: "31st October 2025",
  },
  {
    compliance: "Tax Audit (if applicable)",
    description: "For turnover exceeding ₹1 Cr or ₹10 Cr (if 95% digital)",
    dueDate: "30th September 2025",
  },
  {
    compliance: "MCA Form AOC-4",
    description: "Filing of audited financial statements",
    dueDate: "30th October 2025",
  },
  {
    compliance: "MCA Form MGT-7",
    description: "Filing of Annual Return with Shareholding pattern",
    dueDate: "29th November 2025",
  },
  {
    compliance: "DIR-3 KYC",
    description: "KYC of directors to avoid disqualification",
    dueDate: "30th September 2025",
  },
  {
    compliance: "Form DPT-3",
    description: "Disclosure of loans not treated as deposits",
    dueDate: "30th June 2025",
  },
  {
    compliance: "MSME Return (Form MSME-1)",
    description: "Half-yearly filing for pending dues to MSMEs",
    dueDate: "30th April / 31st October",
  },
  {
    compliance: "Board Meetings",
    description: "Minimum 4 meetings per year (at least one every quarter)",
    dueDate: "Quarterly",
  },
  {
    compliance: "AGM (Annual General Meeting)",
    description: "Mandatory for all companies (except OPCs)",
    dueDate: "Within 6 months of FY end",
  },
];
...
const gstComplianceData = [
  ...
  {
    form: "GSTR-9/9C",
    purpose: "Annual return and reconciliation",
    frequency: "Annually",
  },
  {
    form: "E-Invoicing",
    purpose: "Mandatory if turnover > ₹5 Crores",
    frequency: "Real-time",
  },
];
...
const penalties = [
  ...
  {
    default: "Delay in ROC filings (AOC-4/MGT-7)",
    penalty: "₹100 per day per form",
  },
  { default: "Non-filing of DPT-3", penalty: "₹5,000 + ₹500/day" },
  {
    default: "No board meeting held",
    penalty: "₹25,000 on company + ₹5,000 per director",
  },
  {
    default: "TDS/GST late payment",
    penalty: "Interest @ 1-1.5% per month + penalty",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  ...
                  liability protection, ease of formation and maintenance, and
                  its status as a distinct legal entity. This encourages a
                  prospective businessman to engage in the incorporation of
                  private limited company. A private limited company enjoys
                  legal separation from its owners and necessitates a minimum of
                  two members and two directors for its operation.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  A Private Limited Company offers credibility, scalability, and
                  legal identity but it comes with strict compliance
                  responsibilities under the Companies Act, 2013, Income Tax
                  Act, and GST laws. Failure to comply may result in heavy
                  penalties, director disqualification, and legal issues.
                </p>
                <p className="text-muted-foreground text-justify mb-4">
                  A Private Limited Company (Pvt Ltd), once incorporated under
                  the Companies Act, 2013, is subject to mandatory annual
                  filings, tax obligations, and statutory compliances regardless
                  of turnover or activity level.
                </p>
                ...
                <p className="text-muted-foreground text-justify">
                  Non-compliance can result in hefty penalties, disqualification
                  of directors, and even striking off of the company by ROC.
                </p>
              </div>
                      ...
                      {compliance.title === "Annual ROC Filings" && (
                        <>
                          ...
                          <p className="text-muted-foreground text-sm">
                            Companies must hold AGM within 6 months from FY-end
                            (i.e., by 30th September for most).
                          </p>
                        </>
                      )}
                    </li>
              ...
              <div>
                ...
                <h3 className="font-semibold mt-4 mb-2">
                  Annual Compliances & Event-Based ROC Compliances
                </h3>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  As per the Finance Act, 2024 and recent MCA/Income Tax
                  circulars, here are the key changes impacting Pvt. Ltd.
                  Company compliance:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
