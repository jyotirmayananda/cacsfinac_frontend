...
const registrationSteps = [
  ...
  },
  {
    ...
    items: [
      "Register with the Registrar of Firms (RoF) in the respective state.",
    ],
  },
  {
    title: "Open a Bank Account",
    items: [
      "Submit the notarized deed, PAN, and registration certificate (if applicable) to open a current account.",
    ],
  },
];
...
const penalties = [
  ...
  {
    default: "Failure to Audit",
    penalty: "₹1,50,000 or 0.5% of turnover (Section 271B)",
  },
  {
    default: "Non-registration",
    penalty: "Loss of legal rights to enforce claims",
  },
  {
    default: "Non-maintenance of Books",
...
const ourCoverage = [
  {
    title: "End-to-End Tax Filing",
    description: "ITR-5 preparation, tax computation, e-filing with DSC",
  },
  {
    title: "Tax Audit Assistance",
    description:
      "Preparation of Form 3CD, audit finalization, and tax planning",
  },
  {
    title: "TDS & GST Compliance",
    description: "Quarterly return filing, reconciliation, and advisory",
  },
  {
    title: "Partner Capital & Remuneration Structuring",
    description: "Optimize tax treatment under Section 40(b)",
  },
  {
    title: "Business Registrations",
    description: "GST, MSME, Professional Tax, Shop Act, etc.",
  },
  {
    title: "Notices & Representation",
    description:
      "Handle income tax notices u/s 139(9), 143(2), 142(1), 148, etc.",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  Partnership firms, a prevalent business structure in India,
                  offer an attractive option for small and medium-sized
                  businesses. They combine the ease of setup with the
                  flexibility of shared ownership and management. Here, we’ll
                  delve into what partnership firms are, how to register one,
                  and the essential compliances to navigate.
                </p>
                <p className="text-muted-foreground text-justify mb-4">
                  A partnership firm is a business entity formed by an agreement
                  between two or more individuals (partners) who come together
                  to carry on a business and share the profits or losses. The
                  key aspects of a partnership firm include:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground text-justify">
                  <li>
                    <strong>Minimum and Maximum Partners:</strong> A minimum of
                    two partners is required to form a partnership firm, and the
                    maximum number of partners cannot exceed 20 (except for
                    banking firms).
                  </li>
                  <li>
                    <strong>Shared Ownership and Management:</strong> Partners
                    share ownership of the firm’s assets and liabilities in
                    accordance with the partnership deed, a legal document
                    outlining the rights, responsibilities, profit-sharing
                    ratio, and dispute resolution mechanisms between partners.
                  </li>
                  <li>
                    <strong>Unlimited Liability:</strong> A crucial
                    characteristic of partnership firms is unlimited liability.
                    This means that partners are personally liable for the
                    firm’s debts and obligations beyond the extent of their
              ...
              <div>
                ...
                <ol className="space-y-2 pl-5 list-decimal text-muted-foreground">
                  <li>
                    <strong>Registered Partnership Firm:</strong> Registered
                    with the Registrar of Firms, offering legal protection and
                    the right to sue third parties.
                  </li>
                  <li>
                    <strong>Unregistered Partnership Firm:</strong> Operates
                    without formal registration, but faces limitations like the
                    inability to enforce rights against partners or third
                    parties.
                  </li>
                </ol>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  Why Are Partnership Compliances Important?
                </h2>
                <p className="text-muted-foreground text-justify mb-4">
                  A partnership firm, whether registered or unregistered, must
                  comply with various legal, tax, and regulatory requirements
                  under the Indian Partnership Act, 1932, and the Income Tax
                  Act, 1961. These compliances ensure legal recognition, tax
                  benefits, and avoidance of penalties.
                </p>
                <p className="text-muted-foreground text-justify">
                  Whether you're a startup, traditional family business, or
                  growing enterprise, non-compliance can result in loss of
                  deductions, scrutiny, and interest/penalties from authorities.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 pl-5 list-disc text-muted-foreground">
                  <li>
                    <strong>Tax Rate:</strong> Partnership Firms are taxed at a
                    flat rate of 30% on total income.
                  </li>
                  <li>
                    <strong>Surcharge:</strong> 12% surcharge if total income
                    exceeds ₹1 crore.
                  </li>
                  <li>
                    <strong>Health & Education Cess:</strong> 4% on tax and
                    surcharge.
                  </li>
                  <li>
                    <strong>Remuneration to Partners:</strong> Allowed as a
                    deduction under Section 40(b) up to the prescribed limits.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">
                  CACSFinacc's Compliance Coverage for Partnership Firms
                </h2>
                <ol className="space-y-4 list-decimal pl-5">
