...
const returnTypes = [
  {
    purpose: "One time Return (for prior outstanding as on 31 March 2019)",
    type: "(No longer active)",
  },
  {
    purpose: "Annual Return of Deposits",
    type: "For amounts classified as deposits under Companies Act",
  },
  {
    purpose: "Return of Exempted Borrowings",
    type: "For non-deposit transactions like loans from directors, inter-corporate borrowings",
  },
...
const penalties = [
  {
    default: "Non-filing of DPT-3",
    penalty: "₹5,000 + ₹500 per day of default",
  },
  {
    default: "False Information Filed",
    penalty: "Action under Section 448 – Imprisonment up to 10 years + Fine",
  },
  {
    default: "Not Complying with Section 73",
    penalty:
      "₹1 crore or twice the amount of deposit, whichever is lower + interest",
  },
  {
    default: "Officers in default",
    penalty: "Up to 7 years imprisonment or fine up to ₹25 lakh",
  },
  {
    default: "Additional ROC penalties",
    penalty: "₹100 per day of delay post due date",
  },
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  Every company (except government companies) must file Form
                  DPT-3 with the Ministry of Corporate Affairs (MCA) by June
                  30th each year. This return includes details of all deposits,
                  outstanding loans, and amounts received that do not qualify as
                  deposits as of March 31st. The DPT-3 return must be certified
                  by the company’s auditor to ensure accuracy and compliance.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify mb-4">
                  Form DPT-3 is a mandatory annual return filed by companies
                  (other than government companies) to the MCA, reporting:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                  <li>Deposits</li>
                  <li>
                    Outstanding loans, advances, or monies not considered
                    deposits
                  </li>
                </ul>
                <p className="text-muted-foreground text-justify mt-4">
                  DPT-3 is governed by Rule 16 of the Companies (Acceptance of
                  Deposits) Rules, 2014 under the Companies Act, 2013. It must
                  be filed even if the company does not hold public
                  deposits—reporting of loan-type liabilities is compulsory.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  Private Limited, Public Limited, One Person Company (OPC), and
                  Section 8 Companies are all required to file DPT-3 if any such
                  transactions exist.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-justify">
                  For Financial Year 2024-25 (AY 2025-26), the due date for
                  filing DPT-3 is: <strong>30th June 2025</strong>
                  <br />
                  <em>
